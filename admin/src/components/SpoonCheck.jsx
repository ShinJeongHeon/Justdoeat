// 스푼체크 로고 — landing/src/components/SpoonCheck.jsx 와 동일한 패스.
// 관리자에서도 같은 마크를 쓴다: 방문자가 점심을 결정하듯, 운영자는 출시를 결정한다.

// 원형 배지 (로그인 게이트용): 고추장 레드 원 + 화이트 체크·스푼
...
// currentColor 심볼 (상단바·토스트·랭킹 선택 피드백용)
